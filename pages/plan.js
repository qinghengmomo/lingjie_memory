...
const STATUS_META = {
  ...
  todo:   { label:'待办',   color:'#e2a563',  icon:'○', emptyText:'暂无待办，享受当下' },
  done:   { label:'已完成', color:'#6bc48f',  icon:'✓', emptyText:'还没有完成的事项' },
  dropped:{ label:'已搁置', color:'#b8adb0',  icon:'—', emptyText:'没有搁置的事项' }
};
